...
# normal['java']['tarball'] - Name of the tarball to retrieve from your internal repository, default jdk1.6.0_29_i386.tar.gz
# normal['java']['tarball_checksum'] - Checksum for the tarball, if you use a different tarball, you also need to create a new sha256 checksum
...
# normal['postgresql']['dir'] = '/opt/postgres' # home directory of where postgresql data and configuration lives.
...
## OVERRIDES TO FIX THE COOKBOOK ##
# Cookbook needs to be forked to be fixed....
